...
export class CommunityController {
    ...
    constructor(
        ...
        private get_communitys_service = new GetCommunitysService(),
        private update_community_changeble_properties_service = new UpdateCommunityChangeblePropertiesService(),
        private delete_communitys_service = new DeleteCommunitysService()
    ){}
    ...
    return await wrap<This['getCommunityById']>({name: 'CommunityController/getCommunityById'}, async() =>{
        ...
        try {
            const community = await this.get_communitys_service.getSingleCommunityById(get_community_by_id_requst)
    ...
    return await wrap<This['updateCommunityChangableProperties']>({name: 'CommunityController/updateCommunityChangableProperties'}, async() =>{ 
        ...
        try {
            ...
            const community = await this.get_communitys_service.getSingleCommunityById({community_id:update_community_changable_properties_request.params.community_id})
    ...
    return await wrap<This['deleteCommunityById']>({name: 'CommunityController/deleteCommunityById'}, async() =>{ 
        ...
        try {
            const community = await this.get_communitys_service.getSingleCommunityById({community_id: delete_community_request.community_id})
            await this.delete_communitys_service.DeleteSingleCommunityById(delete_community_request)
